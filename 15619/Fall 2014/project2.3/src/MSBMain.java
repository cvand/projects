...
public class MSBMain {
	...
	public static final String					tagKey		= "Project";
	public static final String					tagValue	= "2.3";
	public static final String					test		= "begin-phase-3";
	public static final String					testId		= "phase";
	public static final String					ELBName		= "MyELB";
	public static final String					ASGGroup	= "ASG";
	public static final String					topicARN	= "arn:aws:sns:us-east-1:167977307745:15619-projects";
	...
	public static void main(String[] args) {
		...
		try {
			...
			CreateLoadBalancerResult elb = elbManager.createELB(ELBName, "us-east-1c", "us-east-1b", "us-east-1a", "sg-294d794c", tagKey, tagValue);
			...
			asManager.createASG(ASGGroup, ELBName, 1, 7, 1, "us-east-1c", "us-east-1b", "us-east-1a", topicARN);
			System.out.println("--Done!");
			...
			// lg = ec2Manager.getLoadGenerator("i-f69cf418");
			// if (lg == null) {
			// lg = createLoadGenerator("ami-7aba0c12", "m3.medium",
			// "15619demo", "launch-wizard-1");
			// }
			lg = createLoadGenerator("ami-7aba0c12", "m3.medium", "15619demo", "launch-wizard-1");
			Thread.sleep(240000);
			System.out.println("--Done!");

			System.out.println("Warming up....");
			WarmUp warmUp = new WarmUp();
			warmUp.run(lg.getPublicDnsName(), elbDnsName, 7);
			System.out.println("--Done!");

			String url = "http://" + lg.getPublicDnsName() + "/" + test + "?dns=" + elbDnsName + "&testId=" + testId;
			System.out.println("-------------------");
			sendRequest(url);
			url = "http://" + lg.getPublicDnsName() + "/view-logs?name=result_cvandera_" + testId + ".txt";
			System.out.println(url);

			Thread.sleep(6001000);
			// sendRequest(url);
			...
			if ( lg != null ) {
				ec2Manager.terminateInstance(lg);
			}
		}
	}

	private static Instance createLoadGenerator(String ami, String type, String key, String secGroup) throws Exception {
		Instance loadGenerator = ec2Manager.createInstance(ami, type, key, secGroup, tagKey, tagValue);
	...
	private static Instance getDnsName(Instance instance) throws Exception {
		...
		if ( (instanceDNS == null) || instanceDNS.equals("") ) { throw new Exception("Could not load public DNS for instance "
